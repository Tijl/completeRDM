%% FIGURE 1: We're using real RDMs here
...
for plot_type = 1:2 % Correlation with full RDM or reconstructed part only
    ...
    lh = legend(ph,'Bracci 2019 (27 × 27)','Robinson 2025 (36 × 36)','Mur 2013 (92 × 92)','Grootswagers 2024 (256 × 256)','Chance');
    lh.Position(1:2) = [x_pos(plot_type)+0.01,0.6];
    legend boxoff;
end

%%% VISUALISE THE RECONSTRUCTION
% We're using the data from Robinson 2025
...
text(0,0.5,'C) Example reconstructions (Robinson 2025)','FontWeight','bold','FontSize',font_size+2);
ax_t.Visible = 'off';
